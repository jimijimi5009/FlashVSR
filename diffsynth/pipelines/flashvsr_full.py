...
""")
    ...
    def init_cross_kv(
        ...
        """
        prompt_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "../../examples/WanVSR/prompt_tensor/posi_prompt.pth")
        if self.dit is None:
    ...
    def encode_video(self, input_video, tiled=True, tile_size=None, tile_stride=None):
        latents = self.vae.encode(input_video, device=self.device, tiled=tiled, tile_size=tile_size, tile_stride=tile_stride)
        return latents

    def decode_video(self, latents, tiled=True, tile_size=None, tile_stride=None):
